                ...
                {auth.isAuthenticated ? (
                  <>
                    <div className="px-3 py-2 text-sm">
                      <p className="font-medium">{auth.user.profile.name}</p>
                      <p className="text-muted-foreground text-xs">{auth.user.profile.email}</p>
                    </div>
                    <DropdownMenuSeparator />
                    ...
                    <Button variant="ghost" size="sm" onClick={() => {auth.removeUser(); signOutRedirect()}}>
                  ...
                  <>
                    <DropdownMenuItem asChild>
                    <Button variant="ghost" size="sm" onClick={() => auth.signinRedirect()}>
